...
function initPage() {
  ...
  const messages = [
    ...
    "anjaii, 18 tahunn mi tawwaaaa. 💫",
    "semoga selalu ki diberikan kebahagiaan sayangg",
    "semoga diberi kii kesehatan, kekuatan, dan kebahagiaan",
    "selamat ulang tahun sayangg",
    "orang yang selalu buat hari' ku lebih berwarna",
    "makasi, sudahh jadi rumah yang kapan pun selalu ada untuk saya",
    "makasiii sudaahh mauu bertahan sama saya, meskipun banyak kekurangan kuu",
    "makasii yaa sayangggkuuu",
    "sayangg ku tauu kuatkii sayangg, pacarrkuu wanitaa kuattt",
    "tapi jangan lupa sayangg, ada ka juga sayangg, bisa ki andalkan kaa sayanggkuu",
    "ku sayangggkii lebihh darii rasa sayanggkuu terhadap diriku sendiri",
    "mauu ka selalu kii bahagiaa sayangg, mau ka kasii bahagia teruss kii",
    "semogaa panjangg umur sayangggg, sehatt selalu,dan diberikan rezeki yang lancarr",
    "sekali lagi sayangg",
    "SELAMAT ULANG TAHUN SAYANGGGKUUU",
    "KUU SAYANGGGGKIIII SELAMANYAAAA❤️"
  ];
  let msgIndex = 0;
